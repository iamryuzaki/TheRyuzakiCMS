...
CREATE TABLE `sessions` (
  ...
  `execution_time` varchar(5) NOT NULL DEFAULT '0',
  `data` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `settings` (`key`, `group`, `value`, `description`) VALUES
('session_lifetime', 1, '24', '');
CREATE TABLE `settings_group` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO `settings_group` (`id`, `name`) VALUES
(1, '{session_and_account_settings_group}');
